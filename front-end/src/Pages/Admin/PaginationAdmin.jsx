        ...
        <div className="full">
            <div className="form-pagination">
                <form onSubmit={searchData}>
                    ...
                    <div>
                        <button className="button-pagination" type="submit">Search</button>
                    </div>
                    <button
                        onClick={BookListSort}
                        className="btn-Descending"
                    >Descending
                    </button>
                    <button
                        className="btn-ascending"
                        onClick={bookListBiasa}
                    >Ascending
                    </button>
                    ...
                    <tbody>
                        {bookList.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td>{item.abstract}</td>
                                <td>
                                    <Button variant="info">Setting</Button>
                                    <Button variant="danger" className="button-td">Delete</Button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
            ...
            <p>Total Buku : {rows}, Page : {rows ? page + 1 : 0} of {pages}</p>
            <div className="paginate">
                <nav className="paginatee" role="navigation">
                    <ReactPaginate className="paginateee"
                        previousLabel={"< Prev"}
                        nextLabel={"> Next"}
                        pageCount={pages}
